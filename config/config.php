...
define('DOMAIN', 'http://localhost:3000'); // Domain (used to create links in emails)
...
// DB Variables - DKIT
$DKIThostname = 'localhost';
$DKITdbname = 'D00225193';
$DKITdsn = 'mysql:host=' . $DKIThostname . ';dbname=' . $DKITdbname;
$DKITusername = 'D00225193';
$DKITpassword = 'CcuoOOy7';

// DB Variables - DKIT
// Not work on Local
$hostinger_host = 'localhost';
$hostinger_db_name = 'id20497813_ops';
$hostinger_dsb = 'mysql:host=' . $hostinger_host . ';dbname=' . $hostinger_db_name;
$hostinger_db_user = 'id20497813_admin';
$hostinger_password = 'localhost';
*/

/// Database settings
$type     = 'mysql';           // Type of database
$server   = 'localhost';       // Server the database is on
$db       = 'ops';             // Name of the database
...
$username = 'ops_admin';       // Enter YOUR username here
$password = 'ops_password';    // Enter YOUR password here
